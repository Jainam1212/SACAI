...
export const Signup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Ensure the mutation includes the name, email, password, and role
